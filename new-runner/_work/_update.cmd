...
set rootfolder=E:\githubactions\nginx-minikube-gha-helm\new-runner
set existrunnerversion=2.314.1
set downloadrunnerversion=2.323.0
set logfile=E:\githubactions\nginx-minikube-gha-helm\new-runner\_diag\SelfUpdate-20250414-164116.log
...
if %restartinteractiverunner% equ 1 (
  ...
  endlocal
  start "Actions Runner" cmd.exe /k "E:\githubactions\nginx-minikube-gha-helm\new-runner\run.cmd"
) else (
  endlocal
)
